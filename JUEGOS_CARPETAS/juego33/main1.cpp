...
int main()
{
    ...
    backgroundTexture.loadFromFile("/home/samira/Escritorio/juego33/imagenesf/background.png");
    playerTexture.loadFromFile("/home/samira/Escritorio/juego33/imagenesf/doodle.png");
    platformTexture.loadFromFile("/home/samira/Escritorio/juego33/imagenesf/platform.png");
...
gameoverBackground.setFillColor(sf::Color::White);
    ...
    sf::Font font;
    font.loadFromFile("/home/samira/Descargas/font/arial.ttf");
    sf::Text scoreText;
...
while (window.pollEvent(event))
        ...
        // I don't know why   if (playerX > window.getSize().x)   doesn't work. so I use 500 instead of window.getSize(>
        // the second if :  if (playerX < -40)   use -40 because window.getSize().x is unsigned int, it can't be negati>
